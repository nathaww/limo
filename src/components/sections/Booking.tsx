...
export function Booking() {
  return (
    <section id="book-now" className="py-32 md:py-40 bg-gradient-to-b from-[#0d1420] to-[#09111d] relative">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#1a2838]/20 via-transparent to-transparent"></div>
      <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="pt-12 border-t border-[#1f2937]/40">
