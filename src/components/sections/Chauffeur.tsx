...
export function Chauffeur() {
  return (
    <section id="chauffeur" className="py-20 md:py-32 bg-[#09111d] relative">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#1a2838]/15 via-transparent to-transparent"></div>
        ...
        <div className="grid md:grid-cols-2 gap-20 md:gap-24 items-center">
          ...
          <div>
            ...
            <p className="text-[#b8b8aa] text-xl leading-relaxed mb-8 open-sans-light">
              With years of experience in executive transportation, Endale brings a calm professionalism 
              to every journey. Punctuality is a given, not a promise.
            </p>
