...
const services = [
  {
    ...
    description: 'Reliable pickups and drop-offs at Denver International and regional airports. Flight monitoring ensures timely arrivals.'
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {services.map((service) => (
            <div 
              key={service.title}
              className="group p-10 bg-gradient-to-br from-[#0d1420]/60 to-[#131b2e]/40 border border-[#1f2937]/30 hover:border-[#d4af6a]/30 transition-all duration-500 hover:shadow-xl hover:shadow-[#d4af6a]/5 relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-[#d4af6a]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
